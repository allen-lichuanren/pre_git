    ...
    <div class="a">
      <div class="row">
        <div class="col-lg-8">
          <div class="hot_news">
            <div class="hot_tab">
              <span class="color_red">精选</span><span>新闻</span>
            </div>
            <div class="hot_list">
              <div class="col-sm-5">
        ...
        <div class="col-lg-4">
            <div class="conjuncture">
                <div class="con_head">
                  <span class="color_red">热门</span><span>行情</span>
                </div>
                <div class="con_list">
            ...
            <div class="news" v-for="item in select.data">
             ...
             <div class="news_article">
               ...
               <div class="news_footer">
                 <span><!-- <span class="read_all" @click=article_detial(item.aid)> 阅读全文</span> --><span class="news_data">{{item.resource}} &bull; {{item.published_time}}</span></span>
...
export default {
    data(){
        return {
            ...
            tabLists:[
                ...
                {name:'项目资讯',show:false,data:[],kind:2},
                {name:'技术前沿',show:false,data:[],kind:3},
                {name:'投资研究',show:false,data:[],kind:4},
                {name:'深度访谈',show:false,data:[],kind:5},
                {name:'专栏',show:false,data:[],kind:6},
                ],
            listData:[],
            conjuncture_list:[
            ...
            sel_coin:'BTC',
            select_tab:false,
            hotNews:[{title:''},{title:''},{title:''},{title:''},{title:''},{title:''}]
        }
    },
    computed:{
        ...mapGetters([
    ...
    methods:{
        ...
        getHotNews(){
          api.getArticles({lanuage:1,page:1,pagesize:5}).then(res=>{
            if(res.code==100){
              com.toast(res.msg_cn);
              return
            }
        ...
        getSvgData(){
          ...
          for(var i=0;i<svgData.length;i++){
            ...
            for(var j=10;j<1000;j++){
              ...
              let max=Math.max(...svgData[i].data);
              // let min=Math.min(...svgData[i].data);
