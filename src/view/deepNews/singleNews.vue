<template>
  <div class="news_list">
      ...
      <div class="box">
        <div class="nav">
          <span><a @click=goBack href="javascript:void(0)">返回</a></span><span>&nbsp;&nbsp;>&nbsp;&nbsp; </span><span>币种深度新闻</span>
        </div>
        <div class="list">
          <div v-for="item in news" class="news">
             ...
             <div class="news_article">
               ...
               <div class="news_footer">
                 <span><!-- <span class="read_all" @click=read_detail(item.aid)> 阅读全文</span> --><span class="news_data">{{item.resource}} &bull; {{item.published_time}}</span></span>
...
export default {
    ...
    methods:{
        ...
        getData(){
          ...
          api.getArticles({lanuage:1,coin:this.coin.split('_')[0],page:this.page,pagesize:3}).then(res=>{
            layer.close(load);
            if(!res||!res.length){
              com.toast('没有更多新闻了');
            }else{
