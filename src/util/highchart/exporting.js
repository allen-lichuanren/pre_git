    ...
    "object" === typeof module && module.exports ? module.exports = h: h(Highcharts)
        ...
        t(A.prototype, {
            ...
            contextMenu: function(a, b, e, c, v, m, g) {
                ...
                d.fixedDiv || d.container), x = r("div", {
                ...
                d.exportEvents.push(q(l, "mouseleave",
                function() {
                ...
                }), d.exportDivElements.push(x, l), d.exportMenuWidth = l.offsetWidth, d.exportMenuHeight = l.offsetHeight);
                b = {
                    display: "block"
                };
                e + d.exportMenuWidth > h ? b.right = h - e - v - w + "px": b.left = e - w + "px";
                c + m + d.exportMenuHeight > H && "top" !== g.alignOptions.verticalAlign ? b.bottom = H - c - w + "px": b.top = c + m - w + "px";
                u(l, b);
                d.openMenu = !0
            },
            addButton: function(a) {
                ...
                if (!1 !== c.enabled) {
                    ...
                    c.text && c.symbol ? h.paddingLeft = B(h.paddingLeft, 25) : c.text || t(h, {
                        width: c.width,
                        height: c.height,
                        padding: 0
                    });
        ...
        A.prototype.renderExporting = function() {
            ...
            c && !1 !== b.enabled && (a.exportEvents = [], a.exportingGroup = a.exportingGroup || a.renderer.g("exporting-group").attr({
                zIndex: 3
            }).add(), F(e,
            function(b) {
                a.addButton(b)
