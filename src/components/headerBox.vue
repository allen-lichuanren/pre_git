  ...
  <div class="navbar">
    <div class="navbar-inner" id="navbar-inner">
      <div class="container">
        <ul class="nav f-l">
          <li>
            <router-link to="/deepNews" class="brand">
        ...
        <ul class="nav f-r">
          <li>
            <div class="btn-group">
              <a class="btn dropdown-toggle" data-toggle="dropdown">语言切换<span class="caret"></span></a>
              <ul class="dropdown-menu" role="menu">
                <li><a @click="changeLan('')" href="javascript:void(0)">简体中文</a></li>
                <li><a @click="changeLan('td')" href="javascript:void(0)">繁体中文</a></li>
              </ul>
            </div>
          </li>
          <li class="login" v-if="!getLoginUser.length"><router-link to="/login">登录</router-link></li>
          <template v-else-if="getLoginUser.length">
             <li class="name"><router-link to="/personalCenter">{{getLoginUser}}</router-link></li>
          </template>
        </ul>
      </div>
    </div>
      ...
      <div class="container">
        <ul class="nav f-l">
          <template v-if="!nav_menu">
            <li :class="{active:nav.deepNews}"><router-link to="/deepNews">深度新闻</router-link></li>
            <li :class="{active:nav.conjuncture}"><router-link to="/conjuncture">行情</router-link></li>
            <li :class="{active:nav.quickNews}"><router-link to="/quickNews">快讯</router-link></li>
            <li ><a href="https://www.centralcrypto.io/" target="_blank">关于中环数字</a></li>
          </template>
          <li v-if="nav_menu">
        ...
        <ul :class="{'nav':true,'f-r':true,'nav_opacity':nav_opacity}">
          ...
          <li v-if="getLoginUser.length">
            <div class="btn-group">
              ...
              <ul class="dropdown-menu menu_bg" role="menu" style="width: 100%">
                <li class="text-center"><a @click="changeLan('')" href="javascript:void(0)">简体中文</a></li>
                <li class="text-center"><a @click="changeLan('td')" href="javascript:void(0)">繁体中文</a></li>
                <li class="login text-center" v-if="!getLoginUser.length"><router-link to="/login">登录</router-link></li>
                <template v-else-if="getLoginUser.length">
                   <li class="text-center"><router-link to="/personalCenter">个人中心</router-link></li>
                </template>
              </ul>
            </div>
          </li>
          ...
          <li v-if="!getLoginUser.length" v-show="!nav_menu" class="login"><router-link to="/login">登录</router-link></li>
        </ul>
        <ul class="meun_list head_bg" v-show="menu_list_fix">
          <li>
            <div ><router-link to="/deepNews">深度新闻</router-link></div>
          </li>
          <li>
            <div ><router-link to="/conjuncture">行情</router-link></div>
          </li>
          <li>
            <div><router-link to="/quickNews">快讯</router-link></div>
          </li>
          <li>
            <div><a href="https://www.centralcrypto.io/" target="_blank">关于中环数字</a></div>
          </li>
        </ul>
      </div>
    </div>
